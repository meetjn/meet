        ...
        {visible.map((article, index) => (
          ...
          >
            ...
            <Link
              ...
              className="grid gap-3 py-12 pl-7 pr-2 sm:grid-cols-[120px_1fr_auto] sm:gap-10 sm:py-14"
            >
              ...
              <div className="min-w-0">
                <h3 className="font-display text-[26px] font-medium leading-[1.15] tracking-[-0.015em] text-portfolio-white transition-colors group-hover:text-portfolio-ember sm:text-[30px]">
                  {article.title}
                </h3>
